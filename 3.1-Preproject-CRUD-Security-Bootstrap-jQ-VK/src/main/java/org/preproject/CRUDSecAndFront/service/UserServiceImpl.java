...
public class UserServiceImpl implements UserService {
    ...
    private User checkRoleData(User user, UserRegistrationDTO userDTO, String fistRole, String secondRole) {
    ...
    private void checkChangePassword(User user, UserRegistrationDTO userDTO) {
        if (!userDTO.getPassword().isEmpty()) {
            user.setPassword(passwordEncoder.encode(userDTO.getPassword()));
        }
    }

    private User checkEqualRole(User user, UserRegistrationDTO userDTO, String ROLE) {
    ...
    private boolean equalsUserDataWithoutRole(User user, UserRegistrationDTO userDTO) {
